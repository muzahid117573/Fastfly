...
public class InshipOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inship_order);
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        mAdapter = new ViewOrderAdapter(InshipOrderActivity.this, order);
    ...
    public void onBackPressed() {
        Intent intent =new Intent(InshipOrderActivity.this,MainActivity.class);
